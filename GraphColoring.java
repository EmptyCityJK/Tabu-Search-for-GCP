/**
 * This is a java implementation of tabu search for
...
public class GraphColoring {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(", coloring with "+nbColor+" colors.");
        TabuColoring tabucol=new TabuColoring(G,nbColor);
        for (int r = 1; r <= nbRound; r++) {
            int[] sol=tabucol.search(); //执行搜索，返回解
            System.out.println();
...
class Graph{
    ...
    public String toString() {
        return String.format("Graph with %d vertices %d edges", this.verNum,this.edgeNum);
    }
}
